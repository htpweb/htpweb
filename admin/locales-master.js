...
function bindMasterLocals(){
 ...
 <div class="card"><div class="row between"><div><h3>Carga masiva multilocal de productos</h3><p class="muted">Un solo Excel puede cargar productos, categorías de menú y variantes para muchos LOCAL. Cada fila identifica su destino con LOCAL y/o LOCAL_ID.</p></div><button id="downloadBulkProductTemplateBtn" class="btn-muted" type="button">Descargar plantilla multilocal de productos</button></div>
 <div class="workspace-note" style="margin-top:14px">Recomendado: usa LOCAL_ID y SKU. LOCAL_ID evita confusiones entre establecimientos con nombres similares y SKU permite actualizar el mismo producto en cargas futuras sin duplicarlo.</div>
