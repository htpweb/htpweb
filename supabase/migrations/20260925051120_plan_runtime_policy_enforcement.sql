...
-- DELIVERY users may trigger the one-time transition application when they enter after a downgrade.
...
-- Restricted areas are enforced at order creation using the customer delivery coordinates.
