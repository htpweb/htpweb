-- HTPWEB — ajuste de confianza para reconocimiento de LOCAL duplicados.
-- Dirección genérica + cercanía geográfica por sí solas quedan como revisión, no como coincidencia automática.
